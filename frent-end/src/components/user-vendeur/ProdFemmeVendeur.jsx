...
function ProdFemmeVendeur({search}) {
  ...
  const productsfemme = products?.filter(e => 
    e.categorie === "femme" && e.title.toLowerCase().includes(search.toLowerCase())
  );
...
export default ProdFemmeVendeur;

...
function ProdHommeVendeur({search}) {
  ...
  const productshomme = products?.filter(e => 
    e.categorie === "homme" && e.title.toLowerCase().includes(search.toLowerCase())
  );
...
export default ProdHommeVendeur;
